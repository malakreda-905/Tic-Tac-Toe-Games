...
private slots:
    ...
    int getBoardIndex(QPushButton* button);
    QLabel* getWinLabelOfBoard(QPushButton* button);
    QGroupBox* getBoardOfButton(QPushButton* button);
    void on_playButton_clicked();
    void on_resetButton_clicked();
    bool is_win_S_board(QGroupBox *boardn);
    bool is_win_B_board();
    void on_checkBox_clicked();
    bool is_draw_S_board(int n, QGroupBox *boardn);
    bool is_draw_B_board();
    void on_checkBox_2_clicked();
    void disableAllBoards();
    void resetPushButtons();
    void resetWinBoardsLable();
    void handleButtonClick(QPushButton *button, QGroupBox *board, QLabel *winLabel, int boardIndex);
